...
/**
 * Pull-latest action: fetch new commits and re-run the full analysis (blocking).
 * Rendered inline in the repository header. A blocking refresh can succeed with
