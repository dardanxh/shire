...
from hobits.integrations.external_tools.bandit import BanditAdapter
...
from hobits.integrations.external_tools.ruff import RuffAdapter
...
from hobits.integrations.external_tools.vulture import VultureAdapter
from hobits.integrations.scanners._common import (
    LANG_BY_EXT,
    NON_CODE_LANGS,
    count_loc,
    walk_files,
