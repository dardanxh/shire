...
from hobits.domain.news.models import NewsItemRow
...
from hobits.domain.roadmap.jobs import build_execute_prompt, build_generate_prompt
...
from hobits.domain.roadmap.repositories import (
...
class RoadmapService:
    ...
    def execute_item(self, roadmap_id: uuid.UUID, item_id: uuid.UUID) -> RoadmapExecutionResult:
        ...
        from hobits.domain.roadmap.execution import ExecutionError, create_execution_worktree
    ...
    def refresh_executions(self, roadmap_id: uuid.UUID) -> RefreshPrsResult:
        ...
        from hobits.domain.connections.services import ConnectionService
        from hobits.domain.repository.domain import GitProvider
        from hobits.domain.roadmap.execution import cleanup_orphan_worktrees
    ...
    def run_drift(self, roadmap_id: uuid.UUID) -> list[RoadmapDriftCheckResult]:
        ...
        from hobits.domain.roadmap.jobs import build_drift_prompt
        from hobits.domain.roadmap.models import RoadmapDriftCheckRow
    ...
    def drift_status(self, roadmap_id: uuid.UUID) -> RoadmapDriftStatusResult:
        from hobits.domain.roadmap.models import RoadmapDriftCheckRow, RoadmapDriftFindingRow
    ...
    def export_markdown(self, roadmap_id: uuid.UUID) -> tuple[str, str]:
        ...
        from hobits.domain.roadmap.export import render_markdown
...
def _issue_body(item: RoadmapItemRow) -> str:
    ...
    parts.append("🤖 Exported from the hobits roadmap.")
    return "\n\n".join(parts)
