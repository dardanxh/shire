...
Run over stdio:  uv run python -m hobits.agent.mcp_server
Register:        claude mcp add hobits -- uv run python -m hobits.agent.mcp_server
Config:          HOBITS_API_BASE (default http://localhost:8000)
"""
...
API_BASE = os.environ.get("HOBITS_API_BASE", "http://localhost:8000").rstrip("/")
