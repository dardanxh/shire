...
from shire.domain.substrate.domain import Scanner
from shire.integrations.scanners.code import (
    CiCdScanner,
    DependencyScanner,
    LanguageScanner,
    LicenseScanner,
...
from shire.integrations.scanners.enrichment import (
    CodeMetricsScanner,
    ComplexityScanner,
    DeadCodeScanner,
    HealthScanner,
...
from shire.integrations.scanners.git import (
    GitStatsScanner,
    HotspotScanner,
    OwnershipScanner,
)
